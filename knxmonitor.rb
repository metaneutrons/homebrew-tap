class Knxmonitor < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "eee1ee796ccc640ef7261bc9aae067c97bb038dd7577b1f7514244830831e0f8" # Will be updated when release is available
    end
    if Hardware::CPU.arm?
      url "https://github.com/metaneutrons/KnxMonitor/releases/download/v#{version}/KnxMonitor-#{version}-osx-arm64.tar.gz"
      sha256 "4750161d2c1195689f9c5e5f0d408d4294c629cf358f647fccd7cb6e81af64df" # Will be updated when release is available
    end
  end
